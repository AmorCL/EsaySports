...
#define CYNavTabView_Tab_Count 4
...
-(void)layoutSubviews{
    ...
    _scrollView.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height-0);
    ...
    CGFloat button_width = SCROLL_WIDTH / (count <=CYNavTabView_Tab_Count ? count : CYNavTabView_Tab_Count);
    ...
    for (UIButton * button in self.buttonArray) {
        ...
        button.frame = CGRectMake(button_width * index, _scrollView.frame.origin.y+20 , button_width , SCROLL_HEIGHT-20);
...
-(void)loadButton{
    ...
    for (int i = 0; i< count; i++) {
        ...
        [self initButton:CGRectMake(button_width * i, self.scrollView.frame.origin.y+20, button_width, SCROLL_HEIGHT-20) title:self.dataArray[i]];
...
- (void)buttonAction:(UIButton *)sender{
    ...
    self.scrollView.contentOffset = CGPointMake(sender.frame.origin.x, 0);
